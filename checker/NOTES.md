...
```
llrt-check ./path/to/function-code.js
```

Then that uses the `./path/to/function-code.js` handler and executes it in `llrt` runtime
...
### 1. Test Function
- Create a test function file that will be executed in both environments
- Should include common Node.js operations to verify compatibility

### 2. Test Execution
- Execute test function using LLRT binary
- Execute same function using standard Node.js runtime
- Compare results between both environments

### 3. Compatibility Verification
- Use `llrt-compatibility.json` to check feature support
- Verify if our code uses any unsupported features
- Document any compatibility issues found

## Implementation Steps
1. Create test function file
2. Set up LLRT binary execution
3. Set up Node.js execution
4. Create comparison logic
5. Document results

## Notes
- LLRT compatibility matrix is generated from official LLRT README
- Test should cover core functionality used in our Lambda functions
- Need to verify both runtime behavior and performance 
